class VendorMailer < ApplicationMailer
  ...
  def invite_email(vendor)
    ...
    mail(
      to: @vendor.email,
      subject: "You have been invited to join TronsDrive as a Vendor"
    )
  end
  ...
  def reject_email(vendor_email, first_name, last_name)
    ...
    mail(
      to: vendor_email,
      subject: "Your request have been rejected to join TronsDrive as a Vendor"
    )
  end
  ...
  def request_email(vendor_request_id)
    ...
    mail(
      to: ENV["FROM_EMAIL"],
      subject: "New request to join TronsDrive as a Vendor"
    )
  end
end
