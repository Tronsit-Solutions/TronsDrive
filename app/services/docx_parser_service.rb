...
class DocxParserService
  ...
  STYLES = {
    ...
    h1: "font-size: 2.25rem; color: #F97316; margin-top: 2.5rem; margin-bottom: 1.5rem; font-weight: 800; line-height: 1.2;",
    h2: "font-size: 1.875rem; color: #F97316; margin-top: 2rem; margin-bottom: 1.5rem; font-weight: 700; line-height: 1.2;",
    h3: "font-size: 1.5rem; color: #F97316; margin-top: 2rem; margin-bottom: 1rem; font-weight: 700;",
    h4: "font-size: 1.25rem; color: #F97316; margin-top: 1.5rem; margin-bottom: 0.75rem; font-weight: 700;",
  ...
  def parse_mixed_nodes(nodes, doc, para_bold = false)
    ...
    nodes.each do |node|
      if node.name == "hyperlink"
        ...
        html_content += "<a href=\"#{url}\" target=\"_blank\" style=\"color: #F97316; text-decoration: underline;\">#{inner_content}</a>"
      else
        # It's a standard run
